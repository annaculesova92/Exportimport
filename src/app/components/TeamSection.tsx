      ...
      <div className="bg-gradient-to-br from-teal-800 via-teal-900 to-teal-950 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-br from-yellow-400/10 to-teal-400/10 rounded-3xl blur-2xl" />
              <div className="relative rounded-2xl overflow-hidden border-2 border-white/10 shadow-2xl shadow-black/30 aspect-[3/4] max-w-[320px] mx-auto lg:max-w-none">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                  <div className="flex items-end justify-between">
                    <div>
                      <h3 className="text-2xl sm:text-3xl font-bold text-white leading-tight">Anna</h3>
                      <span className="text-xs font-bold text-yellow-400 tracking-wider uppercase">Founder & Business Developer</span>
                    </div>
                    <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-lg px-3 py-1.5 shadow-lg shadow-yellow-500/25">
                  ...
                  <div className="flex gap-2 mt-4">
                    {[
                      ...
                      <motion.a
                        ...
                        className="w-9 h-9 rounded-lg bg-white/15 backdrop-blur-sm border border-white/10 flex items-center justify-center text-white/70 hover:bg-yellow-400 hover:text-teal-900 hover:border-yellow-400 transition-colors duration-300"
                      >
                        {s.icon}
                      </motion.a>
                    ))}
            ...
            >
              <div className="mb-6">
                ...
                <div className="w-12 h-1 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full" />
              </div>

              <p className="text-base sm:text-lg text-white/85 font-medium leading-relaxed mb-8">
                {t('team.anna.bio')}
              </p>
              ...
              <motion.div
                ...
                className="p-5 rounded-xl bg-gradient-to-r from-yellow-400/[0.06] to-teal-400/[0.03] border border-yellow-400/10 mb-8"
              >
